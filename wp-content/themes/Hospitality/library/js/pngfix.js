...
DD_belatedPNG.fix( '.reservation_section' );
DD_belatedPNG.fix( '.special_offers' );
DD_belatedPNG.fix( '.download_brochure_in img' );
DD_belatedPNG.fix( '.subscribe_in p' );
DD_belatedPNG.fix( '.subscribe_in .bsubscribe' );
DD_belatedPNG.fix( '.subscribe_in img' );
DD_belatedPNG.fix( 'blockquote' );
DD_belatedPNG.fix( 'h1.head' );
