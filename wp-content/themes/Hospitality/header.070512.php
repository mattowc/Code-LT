...
<script type="text/javascript" src="wp-content/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
<script>
...
<body <?php	 	  body_class(); ?>>
        ...
        <?php	 	  } ?>
            ...
            <?php	 	  if ( get_option('ptthemes_hotel_address') != "") { ?>
 					<div class="address"><?php	 	  echo stripslashes(get_option('ptthemes_hotel_address'));  ?></div>
        <?php	 	  } ?>
