    ...
    <?php	 	  else : ?>
        ...
        <form action="<?php	 	  echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <?php	 	  else : ?>
				...
				<label for="author"><?php	 	  echo get_option('ptthemes_comment_name_name'); ?> <span class="indicates"><?php	 	  if ($req) _e('*'); ?> </span></label></p>

                <p class="commpadd"><input type="text" name="email" id="email" value="<?php	 	  echo $comment_auth_email; ?>" size="22" tabindex="2" />
				<label for="email"><?php	 	  echo get_option('ptthemes_comment_mail_name'); ?> <span class="indicates"><?php	 	  if ($req) _e('*'); ?></span></label></p>

				<p class="commpadd"><input type="text" name="url" id="url" value="<?php	 	  echo $comment_author_url; ?>" size="22" tabindex="3" />
			    <label for="url"><?php	 	  echo get_option('ptthemes_comment_website_name'); ?></label></p>

            <?php	 	  endif; ?>

        <p class="commpadd"> <label>Comment </label> <textarea name="comment" id="comment"  rows="10" cols="10" tabindex="4"></textarea></p>
